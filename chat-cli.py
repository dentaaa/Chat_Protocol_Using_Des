...
class ChatClient:
    ...
    def proses(self, cmdline):
        ...
        try:
            ...
            if (command == 'auth'):
                ...
                encrypted = self.encrypt(key, message, padding=True)
                return self.sendmessage(usernameto, encrypted)
            elif (command == 'inbox'):
                return self.inbox()
            else:
        ...
        try:
            ...
            while True:
                ...
                if (data):
                    ...
                    if receivemsg[-4:] == '\r\n\r\n':
                        print("command berhasil dijalankan")
    ...
    def run(self, key, text, action, padding=False):
        # if len(key) < 8:
